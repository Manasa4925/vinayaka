// Restored original CalendarView component (as it existed before 9:17 PM)
...
const CalendarView: React.FC<CalendarViewProps> = ({ tasks, onStatusChange }) => {
  ...
  if (selectedDate) {
    const tasksForDate = tasks.filter((t) => t.due_date.startsWith(selectedDate));
    return (
          ...
          <div className="w-full max-w-sm glass-panel rounded-2xl border border-glassBorder shadow-2xl p-5 relative">
            ...
            <div className="space-y-3 mb-5">
              ...
              <div className="flex flex-col gap-2 text-xs text-gray-400">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Assignee: {selectedTask.assigned_user ? (
            ...
            {onStatusChange && (
              <div className="flex items-center justify-between gap-3 bg-white/5 border border-white/5 rounded-xl px-3.5 py-2">
                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Quick Update</span>
                <select
